...
const STATIC_ASSETS = [
  './content/images/unit6_banner.webp',
  './content/images/unit5_banner.webp',
  './content/images/unit4_banner.webp',
  './content/images/unit3_banner.webp',
  './content/images/unit2_banner.webp',
  './content/images/unit1_banner.webp',
  './content/images/icon-512.png',
  './content/images/icon-192.png',
  '/manifest.json','/',
  '/index.html',
  '/styles/enhancements.css',
  '/scripts/progress-manager.js',
  '/lib/api-client.js',
  '/content/images/level11_military.webp',
  '/content/images/level11_militaryb.webp',
  '/content/images/level11_militaryc.webp',
  '/content/images/level11_militaryd.webp',
  '/content/images/logo_gu2_mil2.webp'];
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Get Underway', {
      ...
      icon: '/content/images/logo_gu2_mil2.webp',
      badge: '/content/images/logo_gu2_mil2.webp',
